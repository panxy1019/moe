#!/usr/bin/env python3
"""Deep semi-intrusive MoE-ROM v9(2) with longer stability-driven training.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("/root/moe/V9(2)/test_results_v9_2/results")
    )
    parser.add_argument("--experiment-name", default="deep_moe_v9_2")
...
def main() -> None:
    ...
    out = {
        "scheme": "weighted_l2_deep_moe_rom_v9_2_re50_300_long_stability_relative_surrogate_rk4",
