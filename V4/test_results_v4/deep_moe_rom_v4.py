#!/usr/bin/env python3
"""Deep semi-intrusive MoE-ROM v4 experiment on the 30-Re weighted-L2 dataset with rollout curriculum.

The model extends v3 to the mass-weighted 30-Re dataset and adds rollout curriculum:
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("/root/moe/V4/results"))
    parser.add_argument("--experiment-name", default="deep_moe_v4")
...
def rollout_loss_torch(
    ...
    for _ in range(steps):
        ...
        rhs_g = galerkin_rhs_torch(a_cur, b, label_id, gal)
...
def main() -> None:
    ...
    out = {
        "scheme": "weighted_l2_deep_moe_rom_v4_curriculum",
