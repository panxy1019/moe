...
ROOT="/root/moe/V10/test_results_v10"
SCRIPT="${ROOT}/deep_moe_rom_v10.py"
...
run_exp v10_r16_rk4_b2_shared_floor

run_exp v10_r16_lowRe_pressure_focus \
  --test-re-indices 10 \
  --lambda-pressure 0.75 \
  --lambda-rollout 0.12 \
  --lambda-pressure-rollout 0.30 \
  --lambda-pressure-rel 0.70 \
  --rollout-relative-mix 0.45 \
  --relative-floor-frac 0.02 \
  --epochs 180 \
  --min-epochs 100 \
  --patience 35
