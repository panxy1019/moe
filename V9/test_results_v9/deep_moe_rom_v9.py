#!/usr/bin/env python3
"""Deep semi-intrusive MoE-ROM v9 with accuracy-oriented relative losses.

The model keeps the V7/V8 pressure-surrogate residual architecture on the
Re=50-300 100-Re weighted-L2 cylinder dataset and adds relative, amplitude-aware
loss terms for better low-Re accuracy:
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("/root/moe/V9/test_results_v9/results"))
    parser.add_argument("--experiment-name", default="deep_moe_v9")
...
def main() -> None:
    ...
    out = {
        "scheme": "weighted_l2_deep_moe_rom_v9_re50_300_relative_pressure_surrogate_residual_rk4",
