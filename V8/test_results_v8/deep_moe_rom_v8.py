#!/usr/bin/env python3
"""Deep semi-intrusive MoE-ROM v8 with pressure-surrogate residual rollout.

The model retests the V7 pressure-surrogate residual architecture on the
Re=50-300 100-Re weighted-L2 cylinder dataset:
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("/root/moe/V8/test_results_v8/results"))
    parser.add_argument("--experiment-name", default="deep_moe_v8")
...
def main() -> None:
    ...
    out = {
        "scheme": "weighted_l2_deep_moe_rom_v8_re50_300_pressure_surrogate_residual_rk4",
