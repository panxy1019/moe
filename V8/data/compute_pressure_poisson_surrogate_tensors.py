...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data-dir", type=Path, default=DEFAULT_DATA_DIR, help="weighted L2 POD 数据目录")
...
def main() -> None:
    ...
    output = args.output
    if output is None:
        suffix = "allRe100_weightedL2" if args.all_re else str(selected_labels[0])
