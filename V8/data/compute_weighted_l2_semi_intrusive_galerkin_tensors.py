...
本脚本面向 /home/ray/Desktop/Cylinder_Results_Re50_300_100Re_POD 中的
...
DEFAULT_DATA_DIR = Path("/home/ray/Desktop/Cylinder_Results_Re50_300_100Re_POD")
...
def default_vtu_path(data_dir: Path, re_value: float) -> Path:
    ...
    weighted POD 数据集只保存了 uvp npz 和 POD 结果，没有随目录保存 VTU。
...
def main() -> None:
    ...
    output = args.output
    if output is None:
        suffix = "allRe100_weightedL2" if args.all_re else str(re_labels_selected[0])
